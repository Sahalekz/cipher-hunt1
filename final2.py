...
QUESTIONS: List[Dict] = [
    {
        "question": "🔍 Level 1\n\nI can travel without legs. (4 letters)",
    ...
    {
        "question": "🔍 Level 4\n\nI'm XI.I IX IV IV 0 I II , LXXVI.II VII VII IX IX VII VII. (11 letters)",
    ...
    {
        "question": "🔍 Level 5\n\nAn area with stacked family. (10 letters)",
    ...
    {
        "question": "🔍 Level 6\n\nA place where time behaves in strange. (7 letters)",
